...
<div class="auth-container">
    ...
    <div class="auth-form-side">
        <div class="auth-card">
            ...
            <form action="<?php echo e(url('login')); ?>" method="POST" id="loginForm" class="auth-form">
                <?php echo csrf_field(); ?>
                <?php if(request('service')): ?>
                ...
                <?php if(session('status')): ?>
                    <p class="text-success small text-center" id="statusMsg"><?php echo e(session('status')); ?></p>
                <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="you@example.com" required autofocus>
                    </div>
                </div>
                <div class="form-group">
                    <label for="password">Password <a href="<?php echo e(route('password.request')); ?>" class="label-link">Forgot?</a></label>
                    <div class="input-wrap">
                ...
                <div class="form-check mb-4 d-flex justify-content-between align-items-center">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="small text-primary text-decoration-none font-weight-bold">Forgot Password?</a>
                    <?php endif; ?>
                </div>
            ...
            <p class="auth-switch">Don't have an account? <a href="<?php echo e(route('register')); ?>">Create one free</a></p>
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hephz\Documents\CODEBASE\Fuwa.NG\resources\views/auth/login.blade.php ENDPATH**/ ?>