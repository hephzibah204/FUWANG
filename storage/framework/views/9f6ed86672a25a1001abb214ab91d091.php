...
<head>
    ...
    <!-- Fuwa.NG Styles -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/nexus/css/nexus.css?v=' . @filemtime(public_path('assets/nexus/css/nexus.css')) )); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/nexus/css/payment-modal.css?v=' . @filemtime(public_path('assets/nexus/css/payment-modal.css')) )); ?>">
    <!-- Payment Gateway Scripts -->
    <script src="https://js.paystack.co/v1/inline.js" defer></script>
    <script src="https://checkout.flutterwave.com/v3.js" defer></script>
    <script nonce="<?php echo e($cspNonce ?? ''); ?>">
        window.authUserEmail = <?php echo json_encode(Auth::check() ? Auth::user()->email : null, 15, 512) ?>;
    </script>
...
<body class="<?php echo e(Auth::check() ? 'dashboard-body' : ''); ?>">
    <!-- Background Elements -->
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <div class="sidebar-logo">
                ...
                <?php if($logoUrl): ?>
                    <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e(\App\Models\SystemSetting::get('site_name', 'Logo')); ?>" loading="lazy" decoding="async" style="max-height: 30px; margin-right: 10px;">
                <?php else: ?>
                    <i class="fa-solid fa-bolt"></i>
                <?php endif; ?>
                <?php echo e(\App\Models\SystemSetting::get('site_name', 'Fuwa.NG')); ?>

            </div>
            <div class="sidebar-user">
                <div class="sidebar-avatar" style="background: url('<?php echo e(asset('images/avatar-placeholder.png')); ?>') center/cover;"></div>
                <div class="sidebar-user-info">
                    <div class="su-name"><?php echo e(Auth::user()->fullname ?? Auth::user()->username); ?></div>
                    <div class="su-role"><?php echo e(ucfirst(Auth::user()->role ?? 'User')); ?></div>
                </div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item <?php echo e(Request::routeIs('dashboard') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('dashboard')); ?>"><i class="fa-solid fa-house"></i> Overview</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('history') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('history')); ?>"><i class="fa-solid fa-clock-rotate-left"></i> History</a>
            </div>

            <div class="nav-section">Identity & Trust</div>
            <div class="nav-item <?php echo e(Request::routeIs('services.nin') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.nin')); ?>"><i class="fa-solid fa-id-card"></i> NIN Verify</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('services.bvn') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.bvn')); ?>"><i class="fa-solid fa-building-columns"></i> BVN Verify</a>
            </div>
            ...
            <div class="nav-item <?php echo e((Request::routeIs('services.vtu.*') || Request::routeIs('services.airtime*') || Request::routeIs('services.data*')) ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.vtu.hub')); ?>"><i class="fa-solid fa-mobile-screen-button"></i> VTU Hub</a>
            </div>

            <div class="nav-section">Fuwa.NG Ecosystem</div>
            <div class="nav-item <?php echo e(Request::routeIs('services.agency') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.agency')); ?>"><i class="fa-solid fa-store text-info"></i> Agency Banking</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('services.virtual_card') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.virtual_card')); ?>"><i class="fa-solid fa-credit-card text-primary"></i> Virtual Cards</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('services.fx') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.fx')); ?>"><i class="fa-solid fa-arrows-rotate text-purple"></i> FX Exchange</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('services.invoicing') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.invoicing')); ?>"><i class="fa-solid fa-file-invoice-dollar text-warning"></i> Invoicing</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('services.notary') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.notary')); ?>"><i class="fa-solid fa-file-signature text-secondary"></i> Notary Services</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('services.postoffice') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.postoffice')); ?>"><i class="fa-solid fa-mail-bulk text-danger"></i> Post Office</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('services.ticketing') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.ticketing')); ?>"><i class="fa-solid fa-ticket text-accent"></i> Ticketing</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('services.auctions') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('services.auctions')); ?>"><i class="fa-solid fa-gavel text-white-50"></i> Auctions</a>
            </div>

            <div class="nav-section">Settings & Support</div>
            <div class="nav-item <?php echo e(Request::routeIs('profile') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('profile')); ?>"><i class="fa-solid fa-user-gear"></i> Profile</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('profile.activity') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('profile.activity')); ?>"><i class="fa-solid fa-list-check"></i> Activity Log</a>
            </div>
            <div class="nav-item <?php echo e(Request::routeIs('tickets.*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('tickets.index')); ?>"><i class="fa-solid fa-headset text-success"></i> Support Center</a>
            </div>
        </nav>
    ...
    <!-- Main Content Area -->
    <main class="main <?php echo e(Auth::check() ? 'nexus-main' : 'm-0'); ?>">
        <?php if(auth()->guard()->check()): ?>
        <header class="topbar">
            <div class="topbar-greeting">
                Welcome back, <span><?php echo e(explode(' ', Auth::user()->fullname)[0] ?? Auth::user()->username); ?></span>
            </div>
            <div class="topbar-right">
                <div class="wallet-balance d-none d-md-block">
                    <span class="text-muted small">Balance:</span>
                    <h5 class="m-0">₦<?php echo e(number_format(Auth::user()->balance?->user_balance ?? 0, 2)); ?></h5>
                </div>
                <div class="notif-btn">
        ...
        <div class="<?php echo e(Auth::check() ? 'dash-content' : 'container py-5'); ?> fade-in">
            <?php echo $__env->yieldContent('content'); ?>
        </div>

        <footer class="py-4 <?php echo e(Auth::check() ? 'px-4' : ''); ?>" style="margin-top: auto; border-top: 1px solid rgba(255,255,255,0.06); background: rgba(255,255,255,0.02);">
            <div class="<?php echo e(Auth::check() ? '' : 'container'); ?>">
    ...
    <!-- Scripts -->
    <script src="<?php echo e(asset('assets/nexus/js/csrf-fetch.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/nexus/js/nexus.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/nexus/js/payment-modal.js')); ?>"></script>
    <script src="https://unpkg.com/intro.js/minified/intro.min.js"></script>
    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html>
<?php /**PATH /var/www/fuwa.ng/html/resources/views/layouts/app.blade.php ENDPATH**/ ?>