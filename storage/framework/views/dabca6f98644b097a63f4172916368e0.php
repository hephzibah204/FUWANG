...
<body style="margin:0;padding:0;background:#0b1220;color:#e5e7eb;font-family:Arial,Helvetica,sans-serif;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;"><?php echo e($preheader); ?></div>
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;background:#0f172a;border:1px solid rgba(255,255,255,0.08);border-radius:16px;overflow:hidden;">
                    <tr>
                        <td style="padding: 20px 22px; background: linear-gradient(135deg, rgba(59,130,246,0.18), rgba(139,92,246,0.12));">
                            <a href="<?php echo e($homeUrl); ?>" style="text-decoration:none; display:flex; align-items:center; gap:10px;">
                                <?php if($logoUrl): ?>
                                    <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($siteName); ?>" width="36" height="36" style="display:block;border-radius:8px;">
                                <?php else: ?>
                                    <div style="width:36px;height:36px;border-radius:8px;background:rgba(255,255,255,0.12);"></div>
                                <?php endif; ?>
                                <span style="font-size:16px;font-weight:700;color:#ffffff;letter-spacing:0.5px;"><?php echo e($siteName); ?></span>
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 18px 22px; border-top:1px solid rgba(255,255,255,0.06); background: rgba(255,255,255,0.02);">
                            <div style="font-size:12px;line-height:1.6;color:rgba(229,231,235,0.75);">
                                <div><?php echo e(__('emails.footer.reason')); ?></div>
                                <?php if(!empty($contactAddress)): ?>
                                    <div style="margin-top:6px;"><?php echo e($contactAddress); ?></div>
                                <?php endif; ?>
                                <?php if(!empty($contactEmail)): ?>
                                    <div style="margin-top:6px;"><?php echo e(__('emails.footer.support')); ?>: <a href="mailto:<?php echo e($contactEmail); ?>" style="color:#93c5fd;"><?php echo e($contactEmail); ?></a></div>
                                <?php endif; ?>
                                <div style="margin-top:10px;">
                                    <a href="<?php echo e($privacyUrl); ?>" style="color:#93c5fd;"><?php echo e(__('emails.footer.privacy')); ?></a>
                                    <?php if(!empty($unsubscribeUrl)): ?>
                                        <span style="padding:0 8px;">·</span>
                                        <a href="<?php echo e($unsubscribeUrl); ?>" style="color:#93c5fd;"><?php echo e(__('emails.footer.unsubscribe')); ?></a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </td>
...
<?php /**PATH /var/www/fuwa.ng/html/resources/views/emails/layouts/base.blade.php ENDPATH**/ ?>