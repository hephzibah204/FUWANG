<?php $__env->startSection('title', 'Admin Login | ' . config('app.name')); ?>
<?php $__env->startSection('public_wrapper_class', 'none'); ?>
<?php $__env->startSection('hide_nav', 'true'); ?>

<?php $__env->startSection('content'); ?>
<div class="login-wrapper">
    <div class="login-card">
        <div class="login-header">
            <h1><?php echo e(\App\Models\SystemSetting::get('site_name', 'Fuwa.NG')); ?> <span class="badge-admin">Admin</span></h1>
        ...
        <div class="login-footer">
            <a href="<?php echo e(url('/')); ?>" class="text-muted small"><i class="fa-solid fa-arrow-left mr-1"></i> Back to main site</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/fuwa.ng/html/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>