<?php $__env->startSection('title', 'Browse Auctions'); ?>
        ...
        <div class="mb-4 p-3 rounded-lg" style="background: rgba(245, 158, 11, 0.12); border: 1px solid rgba(245, 158, 11, 0.25);">
            <div class="d-flex align-items-start" style="gap: 10px;">
                ...
                <div>
                    ...
                    <div class="text-white-50 small"><?php echo e($dbError); ?></div>
                </div>
            </div>
        </div>
    <?php endif; ?>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 mb-4 mb-lg-0">
                ...
                <div class="d-flex flex-wrap align-items-center" style="gap: 12px;">
                    <?php if($isAuthed): ?>
                        <a href="<?php echo e(route('auction.dashboard')); ?>" class="btn btn-auction-primary">
                            <i class="fa-solid fa-gauge-high mr-2"></i> Open dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('auction.login')); ?>" class="btn btn-auction-primary">
                            <i class="fa-solid fa-arrow-right-to-bracket mr-2"></i> Sign in to bid
                        </a>
                        <a href="<?php echo e(route('auction.register')); ?>" class="btn btn-outline-light" style="border-radius: 12px;">
                ...
                <div class="d-flex flex-wrap mt-4" style="gap: 10px;">
                    <div class="auction-stat">
                        ...
                        <div class="auction-stat__v"><?php echo e(number_format($totalLots)); ?></div>
                    </div>
                    <div class="auction-stat">
                        <div class="auction-stat__k">Categories</div>
                        <div class="auction-stat__v"><?php echo e(number_format(is_iterable($categories ?? null) ? count($categories) : 0)); ?></div>
                    </div>
                    <div class="auction-stat">
                        <div class="auction-stat__k">Last refresh</div>
                        <div class="auction-stat__v"><?php echo e(($updatedAt ?? now())->format('H:i')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <div class="glass-card p-4 auction-search-card">
                    ...
                    <form action="<?php echo e(route('public.auctions.index')); ?>" method="GET">
                        <div class="form-group mb-3">
                            <div class="position-relative">
                                <i class="fa-solid fa-magnifying-glass position-absolute auction-search-ico"></i>
                                <input class="form-control tracking-input pl-5" type="search" name="q" placeholder="e.g. iPhone, A-1000, Land" value="<?php echo e($filters['q']); ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <select name="location" class="form-control tracking-input">
                                    ...
                                    <?php $__currentLoopData = ($locations ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($loc); ?>" <?php if(($filters['location'] ?? '') === $loc): echo 'selected'; endif; ?>><?php echo e($loc); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-7">
                                <select name="sort" class="form-control tracking-input">
                                    <option value="ending_soon" <?php if(($filters['sort'] ?? '') === 'ending_soon'): echo 'selected'; endif; ?>>Ending soon</option>
                                    <option value="newest" <?php if(($filters['sort'] ?? '') === 'newest'): echo 'selected'; endif; ?>>Newest</option>
                                    <option value="price_low" <?php if(($filters['sort'] ?? '') === 'price_low'): echo 'selected'; endif; ?>>Price: Low to High</option>
                                    <option value="price_high" <?php if(($filters['sort'] ?? '') === 'price_high'): echo 'selected'; endif; ?>>Price: High to Low</option>
                                </select>
                            </div>
                    ...
                    <div class="d-flex flex-wrap mt-2" style="gap: 10px;">
                        <?php if(($filters['q'] ?? '') !== '' || ($filters['category'] ?? '') !== '' || ($filters['location'] ?? '') !== '' || ($filters['status'] ?? '') !== ''): ?>
                            <a href="<?php echo e(route('public.auctions.index')); ?>" class="small text-white-50 text-decoration-none">
                                <i class="fa-solid fa-rotate-left mr-1"></i> Clear filters
                            </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('auction.admin.dashboard')); ?>" class="small text-white-50 text-decoration-none">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-end mb-3" style="gap: 12px;">
            ...
            <div class="d-flex align-items-center" style="gap: 10px;">
                <span class="badge badge-pill auction-pill px-3 py-2">
                    ...
                    Sort: <?php echo e($filters['sort'] === 'price_low' ? 'Price Low' : ($filters['sort'] === 'price_high' ? 'Price High' : ($filters['sort'] === 'newest' ? 'Newest' : 'Ending Soon'))); ?>
        ...
        <div class="row">
            <?php $__empty_1 = true; $__currentLoopData = $lots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <a href="<?php echo e(route('public.auctions.show', ['lotCode' => $lot->lot_code])); ?>" class="text-decoration-none d-block h-100">
                        <div class="glass-card h-100 auction-card">
                            <div class="auction-card__img">
                                <?php if($img): ?>
                                    <img src="<?php echo e($img); ?>" alt="<?php echo e($lot->title); ?>">
                                <?php else: ?>
                                    <i class="fa-solid fa-image fa-2x text-white-50"></i>
                                <?php endif; ?>
                                <div class="auction-card__badge">
                                    <span class="badge js-status px-2 py-1" data-code="<?php echo e($lot->lot_code); ?>" style="background: <?php echo e($status === 'live' ? '#ef4444' : ($status === 'scheduled' ? '#3b82f6' : '#6b7280')); ?>;">
                            ...
                            <div class="p-4">
                                <h3 class="h5 text-white font-weight-bold mb-1 auction-truncate"><?php echo e($lot->title); ?></h3>
                                <div class="text-white-50 small mb-3"><?php echo e($lot->category); ?> · Lot <?php echo e($lot->lot_code); ?></div>
                                ...
                                <div class="d-flex justify-content-between align-items-end pt-3 border-top border-white-10">
                                    <div>
                                        ...
                                        <div class="h5 text-primary font-weight-bold mb-0 js-price" data-code="<?php echo e($lot->lot_code); ?>">₦<?php echo e(number_format((float) $lot->current_price, 2)); ?></div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-white-50 small">Ends In</div>
                                        <div class="text-white font-weight-bold mb-0 js-countdown" data-code="<?php echo e($lot->lot_code); ?>" data-end="<?php echo e($endAt); ?>"><?php echo e($lot->end_at ? $lot->end_at->diffForHumans() : '—'); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-12 text-center py-5">
                    ...
                    <a href="<?php echo e(route('public.auctions.index')); ?>" class="btn btn-outline-light">Clear All Filters</a>
                </div>
            <?php endif; ?>
        </div>
...
<script>
(() => {
  const streamUrl = <?php echo json_encode(route('realtime.auctions.stream'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.auction', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/fuwa.ng/html/resources/views/public/auctions/index.blade.php ENDPATH**/ ?>