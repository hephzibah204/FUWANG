<?php $__env->startSection('title', ($service['title'] ?? 'Service') . ' | ' . ($service['tagline'] ?? config('app.name'))); ?>
<?php $__env->startSection('meta_description', $service['summary'] ?? 'Explore services offered by ' . config('app.name')); ?>
<?php $__env->startSection('meta_keywords', implode(', ', [$service['title'], $service['category'], 'Nigeria', 'Fuwa.NG'])); ?>
<?php $__env->startSection('canonical', route('public.services.show', ['slug' => $slug])); ?>

<?php $__env->startSection('og_title', $service['title'] ?? 'Service'); ?>
<?php $__env->startSection('og_description', $service['summary'] ?? 'Explore services offered by ' . config('app.name')); ?>
<?php $__env->startSection('og_image', url('/images/og/service-' . ($slug ?? 'default') . '.jpg')); ?>
...
<div class="container py-5">
    <div class="mb-4">
        <a href="<?php echo e(url('/explore')); ?>" class="text-white-50 text-decoration-none"><i class="fa-solid fa-arrow-left mr-2"></i>Back to services</a>
    </div>

    <div class="p-4 p-lg-5 rounded-lg mb-4" style="background: <?php echo e($gradient); ?>; border: 1px solid rgba(255,255,255,0.10);">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="d-inline-flex align-items-center px-3 py-2 rounded-pill mb-3" style="background: rgba(0,0,0,0.25); border: 1px solid rgba(255,255,255,0.12);">
                    <i class="<?php echo e($service['icon'] ?? 'fa-solid fa-layer-group'); ?> mr-2 text-white"></i>
                    <span class="text-white-50 small">Public preview — actions unlock after login</span>
                </div>
                <h1 class="text-white font-weight-bold mb-2"><?php echo e($heroHeadline); ?></h1>
                <p class="text-white-50 mb-0" style="max-width: 70ch;"><?php echo e($heroSubheadline); ?></p>
                ...
                <div class="mt-4 d-flex flex-wrap" style="gap: 12px;">
                    <a href="<?php echo e($primary); ?>" class="btn btn-primary" data-cta="service_primary"><?php echo e($primaryLabel); ?></a>
                    <a href="<?php echo e($secondary); ?>" class="btn btn-outline-glass" data-cta="service_secondary"><?php echo e($secondaryLabel); ?></a>
                </div>
            </div>
            <div class="col-lg-4 mt-4 mt-lg-0">
                ...
                <div class="p-3 rounded-lg" style="background: rgba(0,0,0,0.22); border: 1px solid rgba(255,255,255,0.12);">
                    ...
                    <ul class="mb-0 pl-3 text-white-50 small">
                        <?php $__currentLoopData = ($service['highlights'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="mb-1"><?php echo e($h); ?></li>
            ...
            <div class="row">
                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <a href="<?php echo e($mLink); ?>" class="text-decoration-none d-block h-100" data-cta="module_card">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3 d-flex align-items-center justify-content-center" style="width: 44px; height: 44px; border-radius: 14px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.10);">
                                            <i class="<?php echo e($m['icon'] ?? 'fa-solid fa-layer-group'); ?> text-white"></i>
                                        </div>
                                        <div>
                                            <div class="text-white font-weight-bold"><?php echo e($m['title'] ?? 'Module'); ?></div>
                                            <div class="text-white-50 small"><?php echo e($m['subtitle'] ?? ''); ?></div>
                                        </div>
                                    </div>
                                    <?php if($mBadge): ?>
                                        <span class="badge badge-secondary"><?php echo e($mBadge); ?></span>
                                    <?php endif; ?>
                                </div>
    ...
    <?php if(!empty($painPoints)): ?>
        <div class="mb-4">
            <div class="row">
                <?php $__currentLoopData = $painPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 mb-3">
                        <div class="p-4 rounded-lg h-100" style="border: 1px solid rgba(255,255,255,0.10); background: rgba(255,255,255,0.03);">
                            <div class="text-white font-weight-bold mb-2"><?php echo e($p['title'] ?? 'Pain point'); ?></div>
                            <div class="text-white-50 small"><?php echo e($p['body'] ?? ''); ?></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                        ...
                        <div class="p-4 rounded-lg h-100" style="border: 1px solid rgba(255,255,255,0.10); background: rgba(255,255,255,0.03);">
                            <div class="d-flex align-items-center mb-2">
                                <div class="mr-3 d-flex align-items-center justify-content-center" style="width: 42px; height: 42px; border-radius: 14px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.10);">
                                    <i class="<?php echo e($b['icon'] ?? 'fa-solid fa-circle-check'); ?> text-white"></i>
                                </div>
                                <div class="text-white font-weight-bold"><?php echo e($b['title'] ?? 'Benefit'); ?></div>
                            </div>
                            <div class="text-white-50 small"><?php echo e($b['body'] ?? ''); ?></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                ...
                <?php if(!$isAuthed): ?>
                    <div class="position-absolute w-100 h-100" style="top:0;left:0;background: rgba(0,0,0,0.55); backdrop-filter: blur(2px); border-radius: 16px; display:flex; align-items:center; justify-content:center; padding: 18px;">
                        <div class="text-center" style="max-width: 520px;">
                            <div class="text-white font-weight-bold mb-2">Sign in to use <?php echo e($service['title']); ?></div>
                            ...
                            <div class="d-flex justify-content-center flex-wrap" style="gap: 10px;">
                                <a class="btn btn-primary" href="<?php echo e(route('register')); ?>" data-cta="lockout_register">Create account</a>
                                <a class="btn btn-outline-glass" href="<?php echo e(route('login')); ?>" data-cta="lockout_login">Sign in</a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <div class="col-lg-4 mb-4">
            <div class="p-4 rounded-lg" style="border: 1px solid rgba(255,255,255,0.10); background: rgba(255,255,255,0.03);">
                ...
                <div class="mt-4">
                    ...
                    <a href="<?php echo e(url('/explore')); ?>" class="btn btn-outline-glass w-100" data-cta="next_explore">Explore more services</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-4 mb-3 mb-md-0">
                                    <div class="p-4 rounded-lg h-100" style="background: rgba(0,0,0,0.18); border: 1px solid rgba(255,255,255,0.10);">
                                        <div class="text-white font-weight-bold mb-2"><?php echo e((int) $i + 1); ?>. <?php echo e($s['title'] ?? 'Step'); ?></div>
                                        <div class="text-white-50 small"><?php echo e($s['body'] ?? ''); ?></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
            ...
            <div class="row">
                <?php $__currentLoopData = $faq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-6 mb-3">
                        <div class="p-4 rounded-lg h-100" style="border: 1px solid rgba(255,255,255,0.10); background: rgba(255,255,255,0.03);">
                            <div class="text-white font-weight-bold mb-2"><?php echo e($f['q'] ?? ''); ?></div>
                            <div class="text-white-50 small"><?php echo e($f['a'] ?? ''); ?></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <?php if(!empty($closing)): ?>
        <div class="mb-2">
            <div class="p-4 p-lg-5 rounded-lg" style="background: <?php echo e($gradient); ?>; border: 1px solid rgba(255,255,255,0.10);">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <h2 class="h4 text-white font-weight-bold mb-2"><?php echo e($closing['headline'] ?? 'Ready to get started?'); ?></h2>
                        <div class="text-white-50 mb-0" style="max-width: 80ch;"><?php echo e($closing['body'] ?? ''); ?></div>
                    </div>
                    <div class="col-lg-4 mt-4 mt-lg-0 d-flex flex-wrap justify-content-lg-end" style="gap: 12px;">
                        <a href="<?php echo e($primary); ?>" class="btn btn-primary" data-cta="closing_primary"><?php echo e($primaryLabel); ?></a>
                        <a href="<?php echo e($secondary); ?>" class="btn btn-outline-glass" data-cta="closing_secondary"><?php echo e($secondaryLabel); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="application/ld+json">
{
    ...
    "@type": "Service",
    "serviceType": "<?php echo e($service['category'] ?? 'General'); ?>",
    "provider": {
        "@type": "Organization",
    ...
    "name": "<?php echo e($service['title'] ?? 'Service'); ?>",
    "description": "<?php echo e($service['summary'] ?? ''); ?>",
    <?php if(!empty($faq)): ?>
    "mainEntity": {
        "@type": "FAQPage",
        "mainEntity": [
    ...
    "potentialAction": {
        "@type": "ViewAction",
        "target": "<?php echo e(route('public.services.show', ['slug' => $slug])); ?>"
    }
}
</script>
<script>
(() => {
  const url = <?php echo json_encode(route('ab.event'), 15, 512) ?>;
  const variant = <?php echo json_encode($variant, 15, 512) ?>;
  const experiment = <?php echo json_encode($experiment, 15, 512) ?>;
  const slug = <?php echo json_encode($slug ?? null, 15, 512) ?>;
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/fuwa.ng/html/resources/views/public/services/show.blade.php ENDPATH**/ ?>