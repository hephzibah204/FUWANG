<?php $__env->startSection('title', 'Instant KYC & All-In-One Business Tools for Nigeria | Fuwa.NG'); ?>
<?php $__env->startSection('meta_description', "Onboard users seamlessly with Nigeria's most reliable NIN and BVN verification. Grow your business with integrated VTU, logistics, auctions, and notary services. Get started for free."); ?>
<?php $__env->startSection('meta_keywords', 'NIN verification Nigeria, BVN validation, KYC Nigeria, identity verification API, VTU services, logistics platform Nigeria, online auctions Nigeria, notary services Nigeria'); ?>
<?php $__env->startSection('canonical', route('home')); ?>

<?php $__env->startSection('og_title', 'Fuwa.NG: Instant KYC & All-In-One Business Tools for Nigeria'); ?>
<?php $__env->startSection('og_description', "Onboard users with reliable NIN/BVN checks. Expand with VTU, logistics, auctions, and legal services on a single platform. Built for growth in Nigeria."); ?>
<?php $__env->startSection('og_image', url('/images/og/home.jpg')); ?>
        ...
        <div class="container home-sales__grid">
            <div class="home-sales__copy">
                ...
                <div class="home-sales__cta" role="group" aria-label="Primary actions">
                    <a class="btn btn-primary" href="<?php echo e($primaryCtaHref); ?>">Create free account</a>
                    <a class="btn btn-outline" href="<?php echo e($salesHref); ?>" target="_blank" rel="noopener noreferrer">Talk to sales</a>
                </div>
            ...
            <div class="home-sales__visual" aria-label="Diverse customers and operators">
                <img
                    src="<?php echo e($assetPrefix); ?>/images/people/hero-human.png"
        ...
        <div class="container">
            ...
            <div class="home-sales__cards" role="list">
                <article class="home-sales__card" role="listitem">
                    ...
                    <a class="home-sales__link" href="<?php echo e($primaryCtaHref); ?>">Verify NIN →</a>
                </article>
                ...
                <article class="home-sales__card" role="listitem">
                    ...
                    <a class="home-sales__link" href="<?php echo e($primaryCtaHref); ?>">Validate BVN →</a>
                </article>
                ...
                <article class="home-sales__card" role="listitem">
                    ...
                    ?>
                    <a class="home-sales__link" href="<?php echo e($logisticsHref); ?>">Explore logistics →</a>
                </article>
                ...
                <article class="home-sales__card" role="listitem">
                    ...
                    ?>
                    <a class="home-sales__link" href="<?php echo e($auctionsHref); ?>">View auctions →</a>
                </article>
                ...
                <article class="home-sales__card" role="listitem">
                    ...
                    ?>
                    <a class="home-sales__link" href="<?php echo e($notaryHref); ?>">Request notary →</a>
                </article>
                ...
                <article class="home-sales__card" role="listitem">
                    ...
                    ?>
                    <a class="home-sales__link" href="<?php echo e($vtuHref); ?>">Open VTU →</a>
                </article>
            </div>
            ...
            <div class="home-sales__more">
                ...
                <a class="home-sales__morelink" href="<?php echo e(url('/explore/services')); ?>">Open full catalog</a>
            </div>
            ...
            <div class="home-sales__catalog" id="homeMoreServices" hidden>
                ...
                <div class="home-sales__cataloggrid" role="list">
                    ...
                    ?>
                    <?php $__currentLoopData = $moreServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="home-sales__catalogitem" role="listitem" href="<?php echo e($ms['href']); ?>"><?php echo e($ms['label']); ?></a>
        ...
        <div class="container">
            ...
            <div class="home-sales__quotes">
                <figure class="home-sales__quote">
                    <img src="<?php echo e($assetPrefix . \App\Support\TestimonialAvatars::webPath('Chioma|Operations|Fintech')); ?>" alt="Customer portrait" width="56" height="56" loading="lazy" decoding="async" style="object-fit: cover; border-radius: 50%;">
                ...
                <figure class="home-sales__quote">
                    <img src="<?php echo e($assetPrefix . \App\Support\TestimonialAvatars::webPath('Yusuf|Compliance|Lending')); ?>" alt="Customer portrait" width="56" height="56" loading="lazy" decoding="async" style="object-fit: cover; border-radius: 50%;">
                ...
                <figure class="home-sales__quote">
                    <img src="<?php echo e($assetPrefix . \App\Support\TestimonialAvatars::webPath('Amaka|Product|Agency')); ?>" alt="Customer portrait" width="56" height="56" loading="lazy" decoding="async" style="object-fit: cover; border-radius: 50%;">
    ...
    <section class="home-sales__section home-sales__cta2" aria-label="Sign up call to action">
        <div class="container home-sales__cta2inner">
            ...
            <div class="home-sales__cta">
                <a class="btn btn-primary" href="<?php echo e($primaryCtaHref); ?>">Create free account</a>
                <a class="btn btn-outline" href="<?php echo e($salesHref); ?>" target="_blank" rel="noopener noreferrer">Contact sales</a>
                <a class="btn btn-link" href="<?php echo e($secondaryCtaHref); ?>">Sign in</a>
            </div>
        </div>
    </section>
...
<link rel="stylesheet" href="<?php echo e($assetPrefix . '/assets/nexus/css/home-sales.css'); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
<script src="<?php echo e($assetPrefix . '/assets/nexus/js/home-sales.js'); ?>" defer></script>
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hephz\Documents\CODEBASE\Fuwa.NG\resources\views/marketing/home.blade.php ENDPATH**/ ?>