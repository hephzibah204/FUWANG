    ...
    <div class="auth-form-side">
        <div class="auth-card">
            ...
            <?php if(session('status')): ?>
                <div class="auth-alert auth-alert-success" role="status"><?php echo e(session('status')); ?></div>
            <?php endif; ?>

            <?php if($errors->any()): ?>
                <div class="auth-alert auth-alert-error" role="alert"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>

            <form action="<?php echo e(route('password.email')); ?>" method="POST" id="forgotForm" class="auth-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="auth-actions">
                    <a href="<?php echo e(route('login')); ?>" class="label-link">Back to sign in</a>
...
<?php echo $__env->make('layouts.nexus', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/fuwa.ng/html/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>