    ...
    public function storeTemplate(Request $request, string $template)
    {
        $templates = [
            'dataverify_nin' => [
                ...
                'priority' => 1,
                'types' => [
                    ['type_key' => 'nin', 'label' => 'NIN Premium', 'meta' => ['path_suffix' => 'nin_premium']],
                    ['type_key' => 'phone', 'label' => 'NIN by Phone', 'meta' => ['path_suffix' => 'nin_premium_phone']],
                    ['type_key' => 'demographic', 'label' => 'NIN by Demographic', 'meta' => ['path_suffix' => 'nin_premium_demo']],
                ],
            ],
            'verifyme_nin' => [
                'name' => 'VerifyMe (NIN)',
            ...
            'robosttech_nin' => [
                ...
                'service_type' => 'nin_verification',
                'endpoint' => 'https://robosttech.com/api',
                'headers' => ['Content-Type' => 'application/json'],
                'config' => [],
                'price' => 200,
                'priority' => 2,
                'types' => [
                    ['type_key' => 'nin', 'label' => 'Search by NIN', 'meta' => ['path_suffix' => 'nin_verify']],
                    ['type_key' => 'phone', 'label' => 'Search by Phone', 'meta' => ['path_suffix' => 'nin_phone']],
                    ['type_key' => 'demographic', 'label' => 'Search by Demographic Data', 'meta' => ['path_suffix' => 'nin_demo']],
                    ['type_key' => 'tracking', 'label' => 'Validation Status', 'meta' => ['path_suffix' => 'validation_status']],
                ],
            ],
            'generic_sms' => [
