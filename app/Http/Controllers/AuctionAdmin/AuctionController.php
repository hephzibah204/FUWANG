...
class AuctionController extends Controller
{
    public function index()
    {
        ...
        return view('auction_admin.auctions.index', compact('lots'));
    }

    public function create()
    {
        $sellers = AuctionSeller::orderBy('name')->get();
        return view('auction_admin.auctions.create', compact('sellers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('auction.admin.auctions.index')->with('success', 'Auction lot created successfully.');
    }
    ...
    public function edit(AuctionLot $lot)
    {
        ...
        $sellers = AuctionSeller::orderBy('name')->get();
        return view('auction_admin.auctions.edit', compact('lot', 'sellers'));
    }
    ...
    public function update(Request $request, AuctionLot $lot)
    {
        ...
        return redirect()->route('auction.admin.auctions.index')->with('success', 'Auction lot updated successfully.');
    }
    ...
    public function sellers()
    {
        ...
        return view('auction_admin.auctions.sellers', compact('sellers'));
    }
    ...
    public function bids(AuctionLot $lot)
    {
        ...
        return view('auction_admin.auctions.bids', compact('lot', 'bids'));
    }
