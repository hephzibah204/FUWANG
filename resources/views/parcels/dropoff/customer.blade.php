    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="mb-4 d-flex justify-content-between align-items-center">
                <h3 class="mb-0">Customer Drop-off</h3>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted mb-4">Scan the barcode on the customer's package or manually enter the tracking number below.</p>

                    <form action="{{ route('parcels.dropoff.customer.process') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select form-select-lg @error('condition') is-invalid @enderror" id="condition" name="condition" required>
                                <option value="good" {{ old('condition') == 'good' ? 'selected' : '' }}>Good (Adequately packaged)</option>
