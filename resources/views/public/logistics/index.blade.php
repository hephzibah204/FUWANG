...
<div class="row align-items-center mt-4 mb-5">
    <div class="col-lg-6 mb-4 mb-lg-0">
        ...
        <div class="d-flex flex-wrap align-items-center">
            @auth
                <a href="{{ route('logistics.dashboard') }}" class="btn btn-po-primary mr-3 mb-2">
                    <i class="fa fa-th-large mr-2"></i> Go to Dashboard
                </a>
                <a href="{{ route('logistics.book') }}" class="btn btn-outline-light mb-2" style="border-radius: 12px;">
                    <i class="fa fa-plus-circle mr-2"></i> Book a Shipment
                </a>
            @else
                <a href="{{ route('logistics.register') }}" class="btn btn-po-primary mr-3 mb-2">
                    <i class="fa fa-user-plus mr-2"></i> Create Account
                </a>
                <a href="{{ route('logistics.login') }}" class="btn btn-outline-light mb-2" style="border-radius: 12px;">
...
<div class="row mt-4 align-items-stretch">
    ...
    <div class="col-lg-6 mb-4">
        <div class="glass-card p-4 h-100">
            ...
            <div class="mt-2">
                @auth
                    <a href="{{ route('logistics.book') }}" class="btn btn-po-primary">
                        <i class="fa fa-plus-circle mr-2"></i> Book Now
                    </a>
                @else
                    <a href="{{ route('logistics.register') }}" class="btn btn-po-primary">
    ...
    <div class="glass-card p-4">
        <div class="row align-items-center">
            <div class="col-lg-5 mb-4 mb-lg-0">
                <img src="{{ asset('images/people/family.webp') }}" alt="Happy customers" class="img-fluid rounded-lg" style="border-radius: 18px; border: 1px solid rgba(255,255,255,0.08);">
            </div>
            <div class="col-lg-7">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="d-flex">
                            <img src="{{ \App\Support\TestimonialAvatars::url('Tracking is super clear') }}" alt="Customer" class="rounded-circle mr-3" style="width: 44px; height: 44px; object-fit: cover;">
                            <div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="d-flex">
                            <img src="{{ \App\Support\TestimonialAvatars::url('Booking takes minutes') }}" alt="Customer" class="rounded-circle mr-3" style="width: 44px; height: 44px; object-fit: cover;">
                            <div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="d-flex">
                            <img src="{{ \App\Support\TestimonialAvatars::url('Great for my online store') }}" alt="Customer" class="rounded-circle mr-3" style="width: 44px; height: 44px; object-fit: cover;">
                            <div>
                ...
                <div class="d-flex flex-wrap mt-3">
                    ...
                    @auth
                        <a href="{{ route('logistics.dashboard') }}" class="btn btn-po-primary mb-2">Open Dashboard</a>
                    @else
                        <a href="{{ route('logistics.register') }}" class="btn btn-po-primary mb-2">Create Account</a>
                    @endauth
                </div>
            </div>
        </div>
    ...
    <div class="glass-card p-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div class="d-flex flex-wrap">
                @auth
                    <a href="{{ route('logistics.book') }}" class="btn btn-po-primary mr-3 mb-2">
                        <i class="fa fa-plus-circle mr-2"></i> Book Shipment
                    </a>
                    <a href="{{ route('logistics.dashboard') }}" class="btn btn-outline-light mb-2" style="border-radius: 12px;">Dashboard</a>
                @else
                    <a href="{{ route('logistics.register') }}" class="btn btn-po-primary mr-3 mb-2">
                        <i class="fa fa-user-plus mr-2"></i> Create Account
                    </a>
                    <a href="{{ route('logistics.login') }}" class="btn btn-outline-light mb-2" style="border-radius: 12px;">Login</a>
                @endauth
            </div>
        </div>
    </div>
