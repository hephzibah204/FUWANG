...
@section('title', 'Create Logistics Account')
...
<div class="row align-items-center" style="min-height: calc(100vh - 180px);">
    <div class="col-lg-6 mb-4 mb-lg-0">
        ...
        <div class="glass-card p-3 d-inline-flex align-items-center">
            <img src="{{ \App\Support\TestimonialAvatars::url('Seamless tracking') }}" alt="Customer" class="rounded-circle mr-3" style="width: 42px; height: 42px; object-fit: cover;">
            <div>
    ...
    <div class="col-lg-6">
        <div class="glass-card p-4 p-md-5">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('logistics.login') }}" class="text-white-50 text-decoration-none small">
            ...
            <div class="mb-4">
                ...
                <div class="d-flex flex-wrap">
                    <a href="{{ route('login') }}?service=logistics&redirect={{ urlencode('/logistics/dashboard') }}"
                    ...
                    <a href="{{ route('auth.google.redirect', ['service' => 'logistics', 'redirect' => '/logistics/dashboard']) }}"
            ...
            <form method="POST" action="{{ route('logistics.register') }}" id="registerForm">
                @csrf
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input id="fullname" name="fullname" type="text" class="form-control tracking-input" required autofocus value="{{ old('fullname') }}">
                        @error('fullname')<small class="text-danger d-block mt-1">{{ $message }}</small>@enderror
                    </div>

                    <div class="form-group col-md-6">
                        <label for="username" class="text-white-50 small">Username</label>
                        <input id="username" name="username" type="text" class="form-control tracking-input" required value="{{ old('username') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="email" name="email" type="email" class="form-control tracking-input" required value="{{ old('email') }}">
                    @error('email')<small class="text-danger d-block mt-1">{{ $message }}</small>@enderror
                </div>

                <div class="form-group">
                    <label for="referral_code" class="text-white-50 small">Invite code (optional)</label>
                    <input id="referral_code" name="referral_code" type="text" class="form-control tracking-input" value="{{ old('referral_code', request('ref') ?? request('referral_code')) }}" placeholder="Enter invite code">
                    @error('referral_code')<small class="text-danger d-block mt-1">{{ $message }}</small>@enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input id="transaction_pin" name="transaction_pin" type="text" class="form-control tracking-input" inputmode="numeric" pattern="[0-9]{4}" maxlength="4" required value="{{ old('transaction_pin') }}">
                        @error('transaction_pin')<small class="text-danger d-block mt-1">{{ $message }}</small>@enderror
                    </div>
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input class="custom-control-input" type="checkbox" name="apply_as_agent" id="apply_as_agent" value="1" {{ old('apply_as_agent') ? 'checked' : '' }}>
                ...
                <div id="agent-fields" class="{{ old('apply_as_agent') ? '' : 'd-none' }}">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="state" class="text-white-50 small">State</label>
                            <select id="state" name="state" class="form-control tracking-input" {{ old('apply_as_agent') ? '' : 'disabled' }}>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="city" name="city" class="form-control tracking-input" {{ old('state') ? '' : 'disabled' }}>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input id="address" name="address" type="text" class="form-control tracking-input" value="{{ old('address') }}" placeholder="Enter your full address">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="phone_number" name="phone_number" type="text" class="form-control tracking-input" value="{{ old('phone_number') }}" placeholder="e.g., 08012345678">
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label text-white-50 small" for="terms">
                            I agree to the <a href="{{ route('pages.show', ['slug' => 'terms']) }}" class="text-decoration-none" style="color: var(--po-primary);">Terms of Service</a>
                        </label>
                    </div>
                </div>
