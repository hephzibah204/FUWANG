            ...
            <div class="col-12 col-md-8 col-lg-5">
                ...
                <div class="card border-0 rounded-4 shadow-lg" style="background: rgba(17, 24, 39, 0.65); backdrop-filter: blur(20px); border: 1px solid rgba(255,255,255,0.08) !important;">
                    <div class="card-body p-4 p-md-5">
                        <div class="text-center mb-4">
                            <h4 class="text-white font-weight-bold mb-2">Create New Password</h4>
                            <p class="text-white-50 small mb-0">Please enter and confirm your new password below.</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="position-relative">
                                    ...
                                    <input type="email" name="email" class="form-control text-white @error('email') is-invalid @enderror" value="{{ $email ?? old('email') }}" required readonly style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding-left: 45px; height: 50px; border-radius: 12px; opacity: 0.7;">
                                </div>
                                @error('email')
                            ...
                            <div class="form-group mb-3">
                                <label class="text-white-50 small mb-2 font-weight-bold">New Password</label>
                                <div class="position-relative">
                                    <i class="fa-solid fa-lock position-absolute text-white-50" style="left: 15px; top: 50%; transform: translateY(-50%);"></i>
                                    <input type="password" name="password" class="form-control text-white @error('password') is-invalid @enderror" placeholder="Enter new password" required autofocus style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); padding-left: 45px; height: 50px; border-radius: 12px;">
                                </div>
                                @error('password')
                                    <span class="text-danger small mt-1 d-block"><i class="fa-solid fa-circle-exclamation mr-1"></i>{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group mb-4">
                                <label class="text-white-50 small mb-2 font-weight-bold">Confirm New Password</label>
                                <div class="position-relative">
                                    <i class="fa-solid fa-lock position-absolute text-white-50" style="left: 15px; top: 50%; transform: translateY(-50%);"></i>
                                    <input type="password" name="password_confirmation" class="form-control text-white" placeholder="Confirm new password" required style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); padding-left: 45px; height: 50px; border-radius: 12px;">
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary btn-block w-100 font-weight-bold py-3 mb-4" style="border-radius: 12px; background: linear-gradient(135deg, var(--clr-primary), var(--clr-primary-hover)); border: none; font-size: 1rem;">
                                Reset Password <i class="fa-solid fa-check ml-2"></i>
                            </button>
                        </form>
                    </div>
                </div>
