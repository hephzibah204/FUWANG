...
<div class="container-fluid py-4">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <a href="{{ route('services.nin', ['mode' => 'validation']) }}" class="card shadow-sm h-100 border-0 hover-lift text-decoration-none">
                <div class="card-body text-center d-flex flex-column justify-content-center p-4">
                    ...
                    <p class="text-muted small mb-0">Submit NIN for processing (not instant) and check status later.</p>
                </div>
            </a>
        </div>
