...
@section('title', 'Create Role - Fuwa.NG Control')
...
<div class="row mb-4 animate__animated animate__fadeInDown">
    <div class="col-12 d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between">
        <div>
            <h3 class="text-white mb-1 font-weight-bold"><i class="fa fa-shield-alt text-primary mr-2"></i> Create Role</h3>
            <p class="text-white-50 mb-0">Define a new role and its permissions</p>
        </div>
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST">
            ...
            <div class="card glass-card border-0 rounded-lg p-4 mb-4" style="background: rgba(255,255,255,0.02); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.05) !important;">
                <div class="form-group mb-4">
                    ...
                    <input type="text" name="name" class="form-control bg-transparent text-white @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. support-manager" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="custom-control custom-checkbox px-0 d-flex align-items-center mb-2" style="gap: 10px;">
                            <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" id="perm_{{ $permission->id }}" {{ in_array($permission->name, old('permissions', [])) ? 'checked' : '' }} class="mr-2" style="width: 18px; height: 18px;">
