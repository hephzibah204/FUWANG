...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-white">Create Page</h1>
            <p class="text-muted">Add a new static page using the visual builder.</p>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.pages.store') }}" method="POST" id="pageForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="text-white-50 small">Slug (optional)</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group h-100">
                                ...
                                <textarea name="seo_description" class="form-control @error('seo_description') is-invalid @enderror" rows="5">{{ old('seo_description') }}</textarea>
