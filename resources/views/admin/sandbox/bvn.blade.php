...
@section('title', 'BVN Sandbox | Admin ' . config('app.name'))

@section('content')
<div class="service-page fade-in">
    <div class="service-header-card mb-4">
        <div class="sh-icon bvn-bg"><i class="fa-solid fa-building-columns"></i></div>
        <div class="sh-text">
            <h1>BVN Suite (Admin Sandbox)</h1>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="panel-card p-4 mb-4">
                <form id="verifyForm" action="{{ route('admin.sandbox.bvn.verify') }}" method="POST">
                    @csrf
                    <div class="form-group mb-4">
                        <label for="bvn" class="font-weight-600 mb-2">Bank Verification Number (BVN)</label>
                        <div class="input-wrap">
                            <i class="fa-solid fa-building-columns"></i>
                            <input type="text" id="bvn" name="bvn" class="form-control" placeholder="Enter 11-digit BVN" maxlength="11" required>
                        </div>
                    </div>
...
@push('styles')
<style>
    .bvn-bg { background: rgba(16, 185, 129, 0.12); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.22); }
</style>
@endpush
