...
// Fetch user's email from session (make sure this session variable is set)
$user_email = $_SESSION['email']; // Ensure this session variable is set

// Fetch data from the all_orders table for the specific user
$sql = "SELECT * FROM all_orders WHERE user_email = ? ORDER BY create_date DESC";
